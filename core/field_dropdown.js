...
Blockly.FieldDropdown.prototype.onBlocklyAction = function(action) {
  if (this.menu_) {
    if (action === Blockly.navigation.ACTION_PREVIOUS) {
      var oldHighlighted = this.menu_.highlightedItem_.content_;
      this.menu_.highlightPrevious();
      var newHighlighted = this.menu_.highlightedItem_.content_;
      var event = new Blockly.Events.Ui(this.sourceBlock_, 'fieldMove', oldHighlighted, newHighlighted);  
